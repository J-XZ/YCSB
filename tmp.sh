sudo ssh node3 "sudo smartctl -a /dev/nvme0n3 >/root/smart3.txt"
sudo ssh node4 "sudo smartctl -a /dev/nvme0n2 >/root/smart4.txt"
sudo ssh node5 "sudo smartctl -a /dev/nvme0n2 >/root/smart5.txt"
...
sudo ssh node3 "sudo smartctl -a /dev/nvme0n3 >/root/smart3_end.txt"
sudo ssh node4 "sudo smartctl -a /dev/nvme0n2 >/root/smart4_end.txt"
sudo ssh node5 "sudo smartctl -a /dev/nvme0n2 >/root/smart5_end.txt"
